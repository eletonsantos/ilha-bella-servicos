        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-10">
          ...
          <div className="lg:col-span-1">
            <Link href="/" className="flex items-center gap-3 mb-5">
              ...
              <div>
                <p className="font-bold text-white text-base">ILHA BELLA</p>
                <p className="text-brand-gold text-sm font-medium">Serviços</p>
              </div>
            </Link>
            <p className="text-slate-400 text-sm leading-relaxed mb-5">
              Serviços residenciais e empresariais com qualidade, agilidade e atendimento 24 horas
            ...
            <ul className="space-y-4">
              ...
              <li className="flex items-center gap-3">
                ...
                <a
                  ...
                  className="text-slate-400 hover:text-brand-gold text-sm transition-colors break-all"
                >
                  {COMPANY.email}
                </a>
              </li>
              ...
              <li className="flex items-center gap-3">
                ...
                <span className="text-slate-400 text-sm">24 horas · 7 dias por semana</span>
              </li>
            </ul>
          </div>
        </div>
