  ...
  return (
    <section className="section-padding bg-brand-blue">
      <div className="container-site text-center">
        <p className="text-brand-gold-light font-semibold text-sm uppercase tracking-widest mb-4">
          Precisa de ajuda agora?
        </p>
        <h2 className="text-3xl sm:text-4xl lg:text-5xl font-bold text-white mb-6 text-balance">
          Atendimento disponível
          <br />
          <span className="text-brand-gold">24 horas por dia</span>
        </h2>
        <p className="text-blue-100 text-lg max-w-xl mx-auto mb-10">
          Não espere o problema piorar. Entre em contato agora e nossa equipe vai cuidar de tudo.
        </p>
