...
export default async function TecnicoContratoFechamentoPage({ params }: Props) {
  ...
  return (
    <div className="max-w-4xl mx-auto space-y-6">
      <div className="flex items-center justify-between print:hidden">
        <Link href={`/tecnico/fechamentos/${closing.id}`} className="inline-flex items-center gap-2 text-sm text-slate-500 hover:text-brand-blue transition-colors">
