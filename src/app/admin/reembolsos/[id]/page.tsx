        ...
        <div className="flex flex-col items-start sm:items-end gap-2">
          ...
          {r.scheduledPaymentDate && (
            <span className="inline-flex items-center gap-1.5 text-xs text-emerald-700 bg-emerald-50 px-3 py-1.5 rounded-full font-medium">
              ...
              Pagamento agendado: {fmtDate(r.scheduledPaymentDate)}
            </span>
          )}
        </div>
      </div>
      ...
      <div className="card p-6">
        ...
        <div className="flex items-center gap-3 bg-slate-50 rounded-xl px-4 py-3">
          <div className="flex-1">
            ...
            <p className="text-sm font-semibold text-dark">{PIX_KEY_TYPE_LABELS[r.technician.pixKeyType] ?? r.technician.pixKeyType}</p>
          </div>
          <div className="flex-1">
            <p className="text-xs text-slate-400 mb-0.5">Chave</p>
            <p className="text-sm font-semibold text-dark">{r.technician.pixKey}</p>
          </div>
        </div>
      </div>
