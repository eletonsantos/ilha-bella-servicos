...
export default function TecnicoDetailError({
  error,
  reset,
}: {
  ...
  useEffect(() => {
    console.error('[TecnicoDetail] client error:', error)
  }, [error])
  ...
  return (
    <div className="max-w-3xl mx-auto space-y-6">
      ...
      <div className="card p-8 text-center space-y-4">
        ...
        <h2 className="text-lg font-bold text-dark">Erro ao carregar técnico</h2>
        <p className="text-sm text-slate-500 max-w-sm mx-auto">
          {error.message || 'Ocorreu um erro inesperado ao exibir este técnico.'}
        </p>
        {error.digest && (
